...
class _CollectionScreenState extends ConsumerState<CollectionScreen> {
  ...
  void showPlayerDetailsSheet(String playerName, List<CardModel> cards) {
    ...
    final uniqueCards = sortedIds.map((id) => uniqueModels[id]!).toList();
    int currentIndex = 0;
    ...
    showDialog<void>(
      ...
      builder: (context) {
        ...
        final maxDialogWidth = mediaSize.width < 700
            ...
            : 680.0;
        final cardPreviewHeight = (maxDialogHeight * 0.42).clamp(250.0, 410.0);
        ...
        return Dialog(
          ...
          child: StatefulBuilder(
            builder: (context, setSheetState) {
              final selectedCard = uniqueCards[currentIndex];
                      ...
                      children: [
                          ...
                          child: PageView.builder(
                            ...
                            itemBuilder: (context, index) {
                              return Padding(
                                ...
                                child: CardWidget(card: uniqueCards[index]),
                              );
                            },
                          ),
                        ),
                        ...
                        Row(
                          ...
                          children: [
                            ...
                            IconButton(
                              onPressed: currentIndex < uniqueCards.length - 1
                                  ? () {
                        ...
                        Wrap(
                          spacing: 8,
                          runSpacing: 8,
                          children: List.generate(uniqueCards.length, (index) {
                            final card = uniqueCards[index];
                            final count = exactCounts[card.id] ?? 0;
                        ...
                        const SizedBox(height: 8),
                        Divider(color: brand.surfaceBorder),
                                    ...
                                    children: [
                                      ...
                                      if (count > 1)
                                        ...
                                        Text(
                                          ...
                                          style:
                                              dialogTheme.textTheme.bodyMedium,
                                        ),
                                    ],
                                  ),
                                );
